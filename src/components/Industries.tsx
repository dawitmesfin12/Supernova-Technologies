    ...
    <section id="industries" className="nv-section">
      <div className="nv-container">
        <div className="nv-section-header">
          ...
          <p>
            We focus on a handful of industries where software has to be reliable, compliant, and
            easy for non‑technical teams to use.
          </p>
        </div>

        <div className="nv-industry-grid">
          <div className="nv-industry-item">
          ...
          <div className="nv-industry-item">
            <h3>Creators & public figures</h3>
            <p>
              Personal websites and platforms for singers, authors, producers, bloggers, and other
              well‑known people. We build branded sites with landing pages, content libraries,
              event dates, and contact forms or booking flows so your audience has one clear place
